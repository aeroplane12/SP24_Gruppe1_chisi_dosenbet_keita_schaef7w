...
public class Main {
    public static void main(String[] args) {
        ...
        manager.changeParameter(new Double[]{400d,5000d,30d,20d,400d,0d});
        manager.calcGroups();
        ...
        manager.changeParameter(new Double[]{400d,400d,1d,20d,30d,0d});
        manager.calcGroups();
        ...
        manager.changeParameter(new Double[]{400d,30d,400d,5000d,20d,0d});
        manager.calcGroups();
